...
// The card shown to everyone for a few seconds when an admin changes / reloads the map (before
// any Workshop download bar): "Changing map to <name>" (or "Reloading <name>"). HTML-escaped.
