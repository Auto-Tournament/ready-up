...
╲ ╲  __<   ╲ ╲  __╲   ╲ ╲  __ ╲  ╲ ╲ ╲╱╲ ╲ ╲ ╲____ ╲     ╲ ╲ ╲_╲ ╲  ╲ ╲  _─╱ 
 ╲ ╲_╲ ╲_╲  ╲ ╲_____╲  ╲ ╲_╲ ╲_╲  ╲ ╲____─  ╲╱╲_____╲     ╲ ╲_____╲  ╲ ╲_╲   
  ...
  PrintRaw(
      ...
      "    - otherwise ReadyUp relays a prefixed chat line and consumes the original to avoid duplicates.\n"
      "  - `.ru` and `.r` visibility can be toggled via readyup.cfg (consume_ru_chat / consume_ready_chat).\n"
      "  - when a match is loaded, ReadyUp enables whitelist + team enforcement:\n"
